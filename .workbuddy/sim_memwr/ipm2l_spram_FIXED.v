...
//////////////////////////////////////////////////////////////////////////////
module ipm2l_spram_v1_8_data_ram #(
...
//                         end
    ...
    integer gen_m;
    // iverilog workaround: seed CS defaults so the comb block is evaluated at t=0
    initial begin
       cs_bit0 = 1'b0;
       csb_bit0 = 1'b0;
       for (gen_m=0; gen_m<ADDR_LOOP_NUM; gen_m=gen_m+1) begin
          cs_bit1_bus[gen_m] = 1'b0;
          cs_bit2_bus[gen_m] = 1'b0;
          csb_bit1_bus[gen_m] = 1'b0;
          csb_bit2_bus[gen_m] = 1'b0;
       end
    end
    generate
    always@(*) begin
